...
def add_initial_products(inventory_local):#fuction for Adds 5 initial products to the inventory
    add_another = True # Flag to control the bucle
    product_count = 0 # Counter for added products
    product_number = 1 # Counter for product 
    ...
    while add_another:
        ...
        while True:
            try:
                ...
                break # Exit quantity input bucle
            except ValueError:
        ...
        if product_count == 5: # Check if 5 products have been added
            add_another = False # Stop the bucle

def add_product(inventory_local):#fuction for Adds a new product to the inventory
...
def consult_product(inventory_local):#fuction for consults 
    ...
    if product_name in inventory_local: # Check if product exists
        ...
        print(f"\033[93m El producto '{product_name}' no se encuentra en el inventario.\033[0m") 

def update_price(inventory_local):#fuction for Updates the price of an existing product in the inventory
    ...
    if product_name in inventory_local: # Check if product exists
        ...
        print(f"\n\033[93m El producto '{product_name}' no se encuentra en el inventario.\033[0m") 

def delete_product(inventory_local):# fuction,for deletes a product from the inventory
...
def display_inventory(inventory_local):
    ...
    if not inventory_local: # Check if inventory is empty
        print("\033[1m\n\033[93m\El inventario esta vacio.\033[0m")
        return
